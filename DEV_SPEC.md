...
- **Warehouse Workflow**：库存、批次、库位、履约风险和补货申请。
- **Procurement Workflow**：补货申请审批、采购单生成和采购单查询。
...
| 范围 | 测试重点 |
| --- | --- |
| Warehouse Workflow | 库存查询、履约风险、补货申请 |
| Procurement Workflow | 补货审批、驳回、批量审批、采购单复用、采购单查询 |
