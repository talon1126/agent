...
| Phase G | 质量评估体系 | 黄金测试集、检索指标、配置驱动 Ragas 生成指标、真实 Query Pipeline 评估入口、策略对比和评估趋势 | [✔] |
